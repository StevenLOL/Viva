...
public class KeywordCorpus {
    ...
    public KeywordCorpus() {
        ...
        try {
            is = new FileInputStream(System.getProperty("user.dir")+"/places.txt");
        ...
        try {
            is = new FileInputStream(System.getProperty("user.dir")+"/time.txt");
            Scanner input = new Scanner(is, "UTF-8");//Ä‘á»�c theo báº£ng mÃ£ utf-8
        ...
        try {
            is = new FileInputStream(System.getProperty("user.dir")+"/person.txt");
            Scanner input = new Scanner(is, "UTF-8");//Ä‘á»�c theo báº£ng mÃ£ utf-8
        ...
        try {
            is = new FileInputStream(System.getProperty("user.dir")+"/relation.txt");
            Scanner input = new Scanner(is, "UTF-8");//Ä‘á»�c theo báº£ng mÃ£ utf-8
