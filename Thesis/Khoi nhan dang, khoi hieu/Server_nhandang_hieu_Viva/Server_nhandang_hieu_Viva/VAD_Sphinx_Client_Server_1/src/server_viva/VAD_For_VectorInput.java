...
//import vad_preparation.WavFile;

public class VAD_For_VectorInput {
	...
	// THRESHOLD_0 = 30;
	// THRESHOLD_1 = 20;
	static final double E0 = 10 * Math.log10(1);
	// E1 tuong tu nhu E0 nhung o moi truong nhieu nhieu nhat
	static final double E1 = 10 * Math.log10(Math.pow(32768, 2)); // ~ 90
	...
	static final double THRESHOLD_0 = 35; // binh thuong la de 30 nhung de 35,
											// 40 lai cho kq tot hon voi vad
											// online 4
	// de 35 thi nguong cat thap hon tuc la kha nang bi mat tieng noi it hon =>
	// nen de 35
	// threshold_1 tuong tu nhu threshold_0 nhung o moi truong it nhieu nhat
	static final double THRESHOLD_1 = 20;
	// an input file .wav
	...
	public VAD_For_VectorInput(int[] vectorSamplesInput,
	...
	public double[] computeRowVectorLTSD(double[][] matrix_LTSE,
		...
		double numInitialSamplesForCompute_Initial_E_And_Initial_NoiseMean = 1000.0;
	...
	public double[] computeRowVectorMarker(double[] vectorRowLTSD,
		...
		for (int i = 0; i < num_InitialFrames_NonDetected; i++) {
			vectorRowMarker[i] = 0;
			// khi chua ap dung thuat toan ta cho marker = 0 de tien cho viec
			// viet ctr online cho nhom viva sau nay
		}
	...
	public double[] computeRowVectorMarkerAfterAdjustment(
		...
		double duration_MIN_nondetected = 1; // in seconds
	...
	public boolean markerForStopRecord(double[] vectorRowMarkerAfterAdjustment,
		...
		double sampleRate = 16000.0; // mac dinh la 16000
		double duration_MIN_ForStopRecord = 1.8; // in seconds, voi 1,5s cho kq
													// kha tot ( chi co nhuoc
													// diem la o lan im lang dau
													// tien cua vad online4 thi
													// hoi lau (mat 4s )
