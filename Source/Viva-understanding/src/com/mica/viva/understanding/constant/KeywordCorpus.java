...
public class KeywordCorpus {
    ...
    public KeywordCorpus() {
        ...
        try {
            is = new FileInputStream(Config.placeAddress);
        ...
        try {
            is = new FileInputStream(Config.timeAddress);
            Scanner input = new Scanner(is, "UTF-8");//Ä‘á»�c theo báº£ng mÃ£ utf-8
        ...
        try {
            is = new FileInputStream(Config.personAddress);
            Scanner input = new Scanner(is, "UTF-8");//Ä‘á»�c theo báº£ng mÃ£ utf-8
        ...
        try {
            is = new FileInputStream(Config.relationAddress);
            Scanner input = new Scanner(is, "UTF-8");//Ä‘á»�c theo báº£ng mÃ£ utf-8
