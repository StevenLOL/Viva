...
public class KeywordTokenizer {
    ...
    public boolean checkTime() {
        ...
        if (eat("tháng", 0)) {
            ...
            if (eat("hai",1)||eat("ba",1)||eat("tư",1)||eat("năm",1)||eat("sáu",1)||eat("bảy",1)||eat("tám",1)||eat("chín",1)||eat("mư�?i",1)||eat("mư�?i một",1)||eat("mư�?i hai",1)) {
                nowWord += " " + words[j + 1];
                j += 2;
                return true;
            }
    ...
    public boolean checkToMessage() {
        ...
        if (eat("gửi", 0) || eat("mở", 0) || eat("trả l�?i", 0)) {
